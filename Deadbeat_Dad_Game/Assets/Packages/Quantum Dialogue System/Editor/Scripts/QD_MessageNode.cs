...
namespace QuantumTek.QuantumDialogue.Editor
{
    ...
    public class QD_MessageNode : QD_Node
    {
        ...
        public override void DrawWindow(int id)
        {
            ...
            EditorGUI.LabelField(new Rect(5, 125, 190, 20), "Phrase ID", QD_DialogueEditor.skin.label);
            ...
            // phill added this
            int fAudioPhrase = (int)EditorGUILayout.IntField(Data.AudioPhrase);

            if (EditorGUI.EndChangeCheck())
            {
                EditorUtility.SetDirty(QD_DialogueEditor.db.DataDB);
                Data.MessageText = fMessage;
                Data.AudioPhrase = fAudioPhrase;
