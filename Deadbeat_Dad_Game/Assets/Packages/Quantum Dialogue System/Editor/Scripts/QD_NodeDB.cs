...
namespace QuantumTek.QuantumDialogue.Editor
{
    ...
    public class QD_NodeDB : ScriptableObject
    {
        ...
        public static bool OnOpenAsset(int instanceID, int line)
        {
            ...
            QD_NodeDB scriptableObject = AssetDatabase.LoadAssetAtPath<QD_NodeDB>(assetPath);

            if (scriptableObject != null) // did we find the asset?
            {
                QD_DialogueEditor.ShowWindow();
                return true;
            }
        ...
        public void CreateNode(QD_NodeType type, Vector2 position)
        {
            ...
            else if (type == QD_NodeType.Message)
            {
                ...
                // phill added this
                // default behaviour, AudioPhrase number match new node ID
                messageData.AudioPhrase = messageData.ID;
